...
// ===== AUDIO (DFPlayer Mini) =====
// void Otto::beginAudio(HardwareSerial& serial, int rxPin, int txPin) {
    // serial.begin(9600, SERIAL_8N1, rxPin, txPin);
    // if (!_dfplayer.begin(serial)) {
        // _audioReady = false;
    // } else {
        // _audioReady = true;
        // _dfplayer.volume(25); // volume default
        // _dfplayer.EQ(DFPLAYER_EQ_NORMAL);
    // }
// }

// void Otto::playSound(int track) {
    // if (_audioReady) {
        // _dfplayer.play(track);
    // }
// }

// void Otto::setVolume(int vol) {
    // if (_audioReady) {
